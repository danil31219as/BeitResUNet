...
class VisionTransformer(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.num_features = self.embed_dim = config.transformer.hidden_size  # num_features for consistency with other models

        self.patch_embed = PatchEmbed(
            img_size=config.image_size, patch_size=config.transformer.patch_size, in_chans=3, embed_dim=self.embed_dim)
        ...
        self.blocks = nn.ModuleList([
            Block(
                ...
                init_values=config.transformer.init_value, window_size=self.patch_embed.patch_shape)
